            ...
            <Form onSubmit={handleSubmit}>
                <Row>
                    <Form.Group className="col-md-6 mb-3">
                        ...
                        <Form.Select aria-label="Select patient" id="patient_id" onChange={handleInputChange} required>
                    ...
                    <Form.Group className="col-md-6 mb-3">
                        ...
                        <Form.Select aria-label="Select doctor" id="doctor_id" onChange={handleInputChange} required>
                    ...
                    <Form.Group className="col-md-6 mb-3">
                        ...
                        <Form.Control type="date" id="date" required onChange={handleInputChange}></Form.Control>
                    </Form.Group>
                    <Form.Group className="col-md-6 mb-3">
                        <Form.Label>Time</Form.Label>
                        <Form.Control type="time" id="time" required onChange={handleInputChange}></Form.Control>
                    </Form.Group>
                    <Form.Group className="col-md-12 mb-3">
                        <Form.Label>Purpose</Form.Label>
                        <Form.Control type="textarea" id="purpose" style={{ height: '50px' }} onChange={handleInputChange} required></Form.Control>
                    </Form.Group>
